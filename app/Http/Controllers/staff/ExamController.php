...
class ExamController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.exam.index')->with('success', 'Ujian berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('staff.exam.index')->with('success', 'Ujian berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staff.exam.index')->with('success', 'Ujian berhasil dihapus!');
    }

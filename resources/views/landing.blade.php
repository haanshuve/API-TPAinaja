...
<body class="bg-white font-sans text-gray-800">
    ...
    <!-- HEADER -->
    <header class="bg-gradient-to-b from-[#FFD83A] to-[#FFF5CC] pb-20">
        <div class="max-w-7xl mx-auto px-8 pt-8 flex justify-between items-center">
            ...
            <nav class="flex space-x-8 text-gray-900 font-medium">
                <a href="#" class="hover:text-yellow-700">Peserta</a>
                <a href="#" class="hover:text-yellow-700">Peserta</a>
                <a href="#" class="hover:text-yellow-700">Peserta</a>
            </nav>
        ...
        <div class="max-w-7xl mx-auto px-8 mt-14 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            <div class="flex justify-center md:justify-end">
                <img src="{{ asset('images/hero-illustration.png') }}" alt="Hero" class="w-[420px] md:w-[460px] drop-shadow-lg">
            </div>
        </div>
    </header>
